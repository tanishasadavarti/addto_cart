...
let productdata=[]
function Fetchdata() {
    fetch("https://shark-tank-backend-xgv8.onrender.com/pitches").then((res) => res.json())
        .then((data) => {
            Cardlist(data)
            productdata=data
        })
...
//    console.log(product) 
fetch("https://shark-tank-backend-xgv8.onrender.com/pitches",{
    method:"POST",
    headers :{
...
function deleteProduct(id) {
    fetch(`https://shark-tank-backend-xgv8.onrender.com/pitches/${id}`, {
        method: "DELETE"
    })
    .then((res) => res.json())
    .then((data) => {
...
function populateform(id){
    fetch(`https://shark-tank-backend-xgv8.onrender.com/pitches/${id}`).then((res)=>res.json())
    .then((data)=>{
        console.log(data)
...
updatePitchBtn.addEventListener("click",()=>{
    ...
    fetch(`https://shark-tank-backend-xgv8.onrender.com/pitches/${updateproductdata.id}`,{
        method:"PUT",
        headers:{
            "Content-Type":"application/json"
        },
...
updatePricePitchPriceButton.addEventListener("click",()=>{
    ...
    fetch(`https://shark-tank-backend-xgv8.onrender.com/pitches/${updateprice.id}`,{
        method:"PUT",
        headers:{
            "Content-Type":"application/json"
        },
